                                ...
                                <tbody>
                                    @foreach ($rosters as $roster)
                                        <tr class="border-b hover:bg-gray-50">
                                            <td class="py-3 px-4">
                                                <a href="{{ route('manage.rosters.show', $roster) }}" class="text-blue-600 hover:text-blue-800 hover:underline">
                                                    {{ $roster->name }}
                                                </a>
                                            </td>
                                            ...
                                            <td class="py-3 px-4 text-center">
                                                <div class="flex items-center justify-center space-x-2">
                                                    <a href="{{ route('manage.rosters.show', $roster) }}" class="text-blue-600 hover:text-blue-900" title="View">
